...
describe('Home Page', () => {
  ...
  describe('Test 2', () => {
    ...
    it('Second list item', () => {
      HomePage.list.find('.list-group-item').eq(1).should('contain', 'List Item 2')
    })
    it('Second list item*s badge', () => {
      HomePage.list.find('.list-group-item').eq(1).find('.badge').should('have.text', '6')
    })
  })
  describe('Test 3', () => {
    it('Text validation', () => {
  ...
  describe('Test 4', () => {
    it('Enabled button validation', () => {
      HomePage.buttonTestForm4.find('[class="btn btn-lg btn-primary"]').should('be.enabled')
    })
    it('Disabled button validation', () => {
      HomePage.buttonTestForm4.find('[class="btn btn-lg btn-secondary"]').should('be.disabled')
    })
  })

  describe('Test 5', () => {
    it('Success message validation', () => {
      HomePage.buttonTestForm5.wait(11000).click()
      HomePage.buttonTestForm5Message.should('contain.text', 'You clicked a button!')
    })
    it('Disabled button validation', () => {
      HomePage.buttonTestForm5.wait(11000).click()
      .should('be.disabled')
